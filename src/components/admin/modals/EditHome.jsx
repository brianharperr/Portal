...
export default function EditHome({ visible, close, nav, verify, data }) {
  ...
  function saveEdit(){
        ...
        dispatch(updateHome(payload2)).unwrap()
        .then(() => {
            close();
  ...
  return (
    ...
    >
        ...
        <Title level={4}>Edit Home</Title>
            ...
            <Button loading={loading}  onClick={() => saveEdit()}>{loading ? 'Saving edits...' : 'Save'}</Button>
          </Form>
