...
//         </Routes>
  ...
  return (
    <BrowserRouter>
      <Routes>
        <Route exact path="/" element={isPortal ? <ProtectedRoute admin={false} alternate={<Login/>}><Dashboard2/></ProtectedRoute> : <ProtectedRoute admin alternate={<LandingPage/>}><Overview/></ProtectedRoute>} />
        <Route exact path="/login" element={isPortal ? <Login/> : <LoginAdmin/>} />

        <Route exact path="/portal/:domain/settings" element={isPortal ? <Missing/> : <ProtectedRoute admin><Settings/></ProtectedRoute>} />
        <Route exact path="/portal/:domain/configuration" element={isPortal ? <Missing/> : <ProtectedRoute admin><PortalView/></ProtectedRoute>} />
        <Route exact path="/portal/:domain/users" element={isPortal ? <Missing/> : <ProtectedRoute admin><PortalView/></ProtectedRoute>} />
        <Route exact path="/portal/:domain/billing" element={isPortal ? <Missing/> : <ProtectedRoute admin><PortalView/></ProtectedRoute>} />

        <Route exact path="/profile" element={isPortal ? <ProtectedRoute><Profile2/></ProtectedRoute> : <ProtectedRoute admin><Profile/></ProtectedRoute>} />

        <Route exact path="/*" element={<p>Page does not exist.</p>} />
      </Routes>
    </BrowserRouter>
  )
}